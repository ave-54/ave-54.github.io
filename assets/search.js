  ...
  <div class="container">
    <div class="row">
    <div class="col">
  <h1 class="wbn">Материалы для обучения и полезная информация в сфере ИБ и в целом ИТ</h1>
  <h3>Здесь всё?</h3>
  <p>Здесь материалы, которые могут быть полезны как для вуза, так и в целом в сфере ИБ и ИТ. Коллекция будет постоянно обновляться</h3>
   <p>&nbsp;</p>
